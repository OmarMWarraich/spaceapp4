    ...
    <TabPanel value={value} index={0}>
      ...
      <div className="status">
        ...
        <div className="social-media-container">
            ...
            <TabPanel value={value} index={4}>Item Five Details</TabPanel>
            <TabPanel value={value} index={5}>Item Six Details</TabPanel>
    <TabPanel value={value} index={6}>Item Seven Details</TabPanel>
</div>
    );
};
